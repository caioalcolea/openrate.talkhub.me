...
| 8 | **Hardening do PWA** | Web Push (VAPID) para notificações in-app além do WhatsApp, robustez da fila offline (background sync), cache de assets/versionamento do service worker, banner de instalação e teste cross-browser (Chrome Android, Safari iOS) | Melhora a experiência do atendente mantendo o produto 100% web |
